...
class BarChart extends React.Component<Props, State> {
  ...
  private onTimeChange(e: React.ChangeEvent<HTMLSelectElement>) {
...
render() {
  const initialCoinType = this.props.coinTypes.length > 0 ?  this.props.coinTypes[0].CoinName : "";
      ...
      <div>
            <label className="pt-label .modifier">
              ...
              <div className="pt-select">
                <select defaultValue={"EUR"} onChange={(e) => this.onCurrencyChange(e)}>
